...
export class ReservationsController {
  ...
  @ApiOperation({ 
    ...
    description: 'Obtiene todas las reservaciones, opcionalmente filtradas por usuario o restaurante'
  })
  @ApiQuery({ 
    name: 'userId', 
    required: false, 
  ...
  @ApiResponse({ status: 200, description: 'Lista de reservaciones del usuario.', type: [Reservation] })
  @ApiResponse({ status: 401, description: 'No autorizado.' })
  @ApiResponse({ status: 500, description: 'Error interno del servidor.' })
  ...
  @ApiResponse({ status: 200, description: 'Lista de reservaciones del restaurante.', type: [Reservation] })
  @ApiResponse({ status: 401, description: 'No autorizado.' })
  @ApiResponse({ status: 403, description: 'Acceso prohibido.' })
  @ApiResponse({ status: 500, description: 'Error interno del servidor.' })
  ...
  @ApiResponse({ status: 200, description: 'Reservación actualizada exitosamente.', type: Reservation })
  @ApiResponse({ status: 400, description: 'Datos inválidos o fecha en el pasado.' })
  @ApiResponse({ status: 401, description: 'No autorizado.' })
  @ApiResponse({ status: 404, description: 'Reservación no encontrada.' })
  @ApiResponse({ status: 500, description: 'Error interno del servidor.' })
  ...
  @ApiParam({ name: 'id', description: 'ID de la reservación', type: Number })
  @ApiResponse({ status: 200, description: 'Reservación confirmada exitosamente.', type: Reservation })
  @ApiResponse({ status: 401, description: 'No autorizado.' })
  @ApiResponse({ status: 403, description: 'Acceso prohibido.' })
  @ApiResponse({ status: 404, description: 'Reservación no encontrada.' })
  @ApiResponse({ status: 500, description: 'Error interno del servidor.' })
  ...
  @ApiParam({ name: 'id', description: 'ID de la reservación', type: Number })
  @ApiResponse({ status: 200, description: 'Reservación cancelada exitosamente.', type: Reservation })
  @ApiResponse({ status: 401, description: 'No autorizado.' })
  @ApiResponse({ status: 404, description: 'Reservación no encontrada.' })
  @ApiResponse({ status: 500, description: 'Error interno del servidor.' })
