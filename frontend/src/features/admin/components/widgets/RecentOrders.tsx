...
const orders: Order[] = [
  { id: '#1234', table: 'Mesa 5', items: 3, total: 45.5, status: 'preparing', time: 'Hace 5 min' },
  { id: '#1235', table: 'Mesa 12', items: 5, total: 78.2, status: 'ready', time: 'Hace 12 min' },
  { id: '#1236', table: 'Mesa 3', items: 2, total: 32.0, status: 'pending', time: 'Hace 2 min' },
  {
    id: '#1237',
    table: 'Mesa 8',
    items: 4,
  ...
  { id: '#1238', table: 'Mesa 15', items: 6, total: 92.3, status: 'preparing', time: 'Hace 8 min' },
];
            ...
            <div key={order.id} className="p-4 hover:bg-gray-50 transition-colors cursor-pointer">
              <div className="flex items-center justify-between">
                ...
                <div className="text-right">
                  ...
                  <span
                    className={`inline-flex items-center px-2 py-1 rounded-full text-xs font-medium ${status.color} ${status.bg}`}
                  >
                    {status.label}
                  </span>
                </div>
