  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (err.response) {
        ...
        errorMessage =
          'No se pudo conectar con el servidor. Verifica tu conexión y que el backend esté corriendo en http://localhost:8000';
      } else {
        // Otro tipo de error
  ...
  return (
    <div className="flex flex-col lg:flex-row min-h-screen overflow-hidden">
      ...
      <div className="hidden lg:flex lg:w-1/2 xl:w-3/5 min-h-screen relative">
        <img className="w-full h-full object-cover opacity-70" src={Bg_Login} alt="bg-login" />
        {/* Texto sobrepuesto */}
        <div className="absolute inset-0 flex flex-col items-center justify-center text-white bg-gradient-to-br from-black/60 via-black/50 to-transparent backdrop-blur-sm p-8">
          <div className="max-w-xl">
            ...
            <p className="text-base md:text-lg leading-relaxed text-gray-100 font-light">
              Plataforma inteligente para la administración de múltiples restaurantes. Control
              total, insights en tiempo real, operación optimizada.
            </p>
