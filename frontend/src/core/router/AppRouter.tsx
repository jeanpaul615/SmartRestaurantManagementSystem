    ...
    <Routes>
      ...
      <Route element={<ProtectedRoute />}>
        ...
        <Route element={<DashboardLayout />}>
          ...
          <Route
            path="/reservations"
            element={<div className="p-6">Reservations - En construcción</div>}
          />
          <Route path="/staff" element={<div className="p-6">Staff - En construcción</div>} />
          <Route
            path="/analytics"
            element={<div className="p-6">Analytics - En construcción</div>}
          />
          <Route
            path="/notifications"
            element={<div className="p-6">Notifications - En construcción</div>}
          />
